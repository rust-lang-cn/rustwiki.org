+++
title = "TOML 语言规范 1.0 正式版"
description = "TOML 是 Rust 程序的默认配置文件，学习 Rust 语言需要对 TOML 语言有一定的了解。Rust Wiki 在此提供了 TOML 1.0 版的语言全部规范，在学习 Rust 程序设计语言的时候，方便大家查阅和掌握有关要点。"
weight = 5
...
>
> 👉 本文来自 [`toml-lang` 的中文翻译版本](https://github.com/toml-lang/toml.io/blob/f34eaf5ca56321599f6736047c771353e3260345/specs/cn/v1.0.0.md)，本文收录在此处，只是方便 Rust 学习者统一查阅，若是发现有任何错误或需要完善地方，请在 [`toml.io` 原项目仓库](https://github.com/toml-lang/toml.io)指出或修改错误。
...
- [浮点数](#fu-dian-shu)
- [布尔值](#bu-er-zhi)
- [坐标日期时刻](#zuo-biao-ri-qi-shi-ke)
- [各地日期时刻](#ge-di-ri-qi-shi-ke)
- [各地日期](#ge-di-ri-qi)
- [各地时刻](#ge-di-shi-ke)
- [数组](#shu-zu)
- [表](#biao)
- [内联表](#nei-lian-biao)
- [表数组](#biao-shu-zu)
- [文件扩展名](#wen-jian-kuo-zhan-ming)
- [MIME 类型](#mime-lei-xing)
- [ABNF 语法](#abnf-yu-fa)
...
有关点分隔键定义表的详细信息，请参阅后文[表](#biao)一节。  
...
表名的规则与键名相同（见前文[键名](#jian-ming)定义）。  
